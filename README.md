...
[厂商信息(排名、级别等)](https://github.com/bugxio/BVRS/blob/master/exchange/2020_02_05.csv)
...
- `A`、`B`、`C`厂商需要：
    ...
    1. [收录交易所](https://github.com/bugxio/BVRS/blob/master/exchange/2020_02_05.csv)列表中
